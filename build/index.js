...
export class ImageCache {
    ...
    getPath(uri, immutable) {
        ...
        if (immutable === true) {
            return this.BASE_DIR + "/" + SHA1(uri) + ext;
        }
        else {
            return this.BASE_DIR + "/" + s4() + s4() + "-" + s4() + "-" + s4() + "-" + s4() + "-" + s4() + s4() + s4() + ext;
        }
    }
    static get(fileName) {
    ...
    clear() {
        this.cache = {};
        return RNFetchBlob.fs.unlink(this.BASE_DIR);
    }
